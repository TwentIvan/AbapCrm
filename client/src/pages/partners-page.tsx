...
export default function PartnersPage() {
  ...
  const tableColumns = [
    ...
    createTextColumn('website', 'Sito Web', 25),
    createTextColumn('domain', 'Dominio', 20),
    createTextColumn('position', 'Posizione', 20),
    createTextColumn('street', 'Via', 30),
    createTextColumn('streetNumber', 'Civico', 8),
    createTextColumn('city', 'Città', 20),
    createTextColumn('province', 'Provincia', 10),
    createTextColumn('postalCode', 'CAP', 8),
    createTextColumn('country', 'Paese', 15),
    createTextColumn('address', 'Indirizzo Completo', 40),
    ...
    createTextColumn('notes', 'Note', 40),
    {
      ...
      cell: ({ row }: any) => row.original.createdAt ? new Date(row.original.createdAt).toLocaleDateString('it-IT') : '-',
    },
    {
      accessorKey: 'updatedAt',
      header: 'Ultimo Aggiornamento',
      cell: ({ row }: any) => row.original.updatedAt ? new Date(row.original.updatedAt).toLocaleDateString('it-IT') : '-',
    },
    {
      id: 'actions',
      header: 'Azioni',
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <TableConfiguration
        ...
        availableColumns={availableColumns.length > 0 ? availableColumns : [
          ...
          { id: 'street', label: 'Via' },
          { id: 'streetNumber', label: 'Civico' },
          { id: 'city', label: 'Città' },
          { id: 'province', label: 'Provincia' },
          { id: 'postalCode', label: 'CAP' },
          { id: 'country', label: 'Paese' },
          { id: 'address', label: 'Indirizzo Completo' },
          { id: 'fiscalCode', label: 'Codice Fiscale' },
          { id: 'vatNumber', label: 'Partita IVA' },
          { id: 'notes', label: 'Note' },
          { id: 'createdAt', label: 'Data Creazione' },
          { id: 'updatedAt', label: 'Ultimo Aggiornamento' },
        ]}
        editingLayout={editingLayout}
        onSave={(layoutData) => {
