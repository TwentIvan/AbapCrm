  ...
  return (
    ...
    >
      <GripVertical 
        ...
        {...listeners} 
      />
      <div className="flex items-center px-3 py-2 rounded-full nav-box transition-colors flex-1" style={{ backgroundColor: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.2)', minWidth: '220px', maxWidth: '220px' }}>
  ...
  return (
    ...
    >
      <GripVertical 
        ...
        {...listeners} 
      />
      <div className="flex items-center px-3 py-1 rounded-full nav-box transition-colors flex-1" style={{ backgroundColor: 'rgba(59, 130, 246, 0.1)', border: '1px solid rgba(59, 130, 246, 0.2)', minWidth: '200px', maxWidth: '200px' }}>
