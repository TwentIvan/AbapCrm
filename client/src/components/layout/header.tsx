    ...
    <header className="bg-card sticky top-0 z-10">
      ...
      <div className="px-6 py-4 flex items-center justify-between relative overflow-hidden">
        ...
        <div className="flex items-stretch space-x-1">
          ...
          <div 
            className="flex items-center space-x-3 px-4 py-2 bg-sidebar-accent border-[6px] border-blue-700/25 dark:border-blue-600/25 transition-all duration-200"
            style={{ 
          ...
          <div 
            className="flex items-center px-4 py-2 bg-sidebar-accent border-[6px] border-blue-700/25 dark:border-blue-600/25 cursor-pointer transition-all duration-300"
            style={{ 
        ...
        <div className="flex items-center space-x-4">
          <TooltipProvider delayDuration={300}>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Link href="/proposals">
                <Button 
                  variant="ghost" 
                  className="flex items-center bg-sidebar-accent border-[6px] border-blue-700/25 dark:border-blue-600/25 relative"
                  style={{
              ...
              <Link href="/calendar">
                <Button 
                  variant="ghost" 
                  className="flex items-center bg-blue-50/90 dark:bg-blue-900/60 border-[6px] border-blue-700/25 dark:border-blue-600/25"
                  style={{
          ...
          {user && (
            <div 
              className="relative rounded-lg px-4 py-2 flex items-center space-x-4 bg-sidebar-accent border-[6px] border-blue-700/25 dark:border-blue-600/25 transition-all duration-200"
            >
