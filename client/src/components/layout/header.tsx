    ...
    <header className="bg-card border-b border-border sticky top-0 z-10">
      ...
      <div className="px-6 py-4 flex items-center justify-between relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-50">
          ...
          <div className="absolute top-0 left-[0%] w-[10%] h-full bg-blue-500 dark:bg-blue-700" style={{ clipPath: 'polygon(0 0, 100% 15%, 85% 100%, 0 90%)', zIndex: 1 }}></div>
          <div className="absolute top-0 left-[12%] w-[13%] h-full bg-white dark:bg-gray-800" style={{ clipPath: 'polygon(10% 0, 100% 0, 95% 100%, 0 100%)', zIndex: 2 }}></div>
          <div className="absolute top-0 left-[25%] w-[11%] h-full bg-sky-500 dark:bg-sky-700" style={{ clipPath: 'polygon(0 20%, 100% 0, 100% 80%, 0 100%)', zIndex: 1 }}></div>
          <div className="absolute top-0 left-[38%] w-[10%] h-full bg-blue-600 dark:bg-blue-600" style={{ clipPath: 'polygon(15% 0, 100% 10%, 90% 100%, 0 85%)', zIndex: 3 }}></div>
          <div className="absolute top-0 left-[48%] w-[14%] h-full bg-cyan-500 dark:bg-cyan-700" style={{ clipPath: 'polygon(0 0, 100% 25%, 80% 100%, 5% 95%)', zIndex: 2 }}></div>
          <div className="absolute top-0 left-[62%] w-[10%] h-full bg-white dark:bg-gray-700" style={{ clipPath: 'polygon(0 10%, 100% 0, 100% 90%, 0 100%)', zIndex: 1 }}></div>
          <div className="absolute top-0 left-[73%] w-[13%] h-full bg-blue-400 dark:bg-blue-700" style={{ clipPath: 'polygon(20% 0, 100% 5%, 85% 100%, 0 95%)', zIndex: 2 }}></div>
          <div className="absolute top-0 left-[85%] w-[10%] h-full bg-sky-600 dark:bg-sky-600" style={{ clipPath: 'polygon(0 0, 100% 15%, 100% 100%, 10% 100%)', zIndex: 3 }}></div>
          
          {/* Strato 2 - Triangoli per movimento */}
          <div className="absolute top-0 left-[8%] w-[8%] h-full bg-cyan-400 dark:bg-cyan-700" style={{ clipPath: 'polygon(0 0, 100% 40%, 0 100%)', zIndex: 4 }}></div>
          <div className="absolute top-0 left-[20%] w-[7%] h-full bg-blue-500 dark:bg-blue-600" style={{ clipPath: 'polygon(50% 0, 100% 100%, 0 100%)', zIndex: 5 }}></div>
          <div className="absolute top-0 left-[35%] w-[10%] h-full bg-white dark:bg-gray-800" style={{ clipPath: 'polygon(100% 0, 100% 100%, 0 60%)', zIndex: 4 }}></div>
          <div className="absolute top-0 left-[55%] w-[8%] h-full bg-sky-400 dark:bg-sky-700" style={{ clipPath: 'polygon(0 30%, 100% 0, 100% 100%)', zIndex: 5 }}></div>
          <div className="absolute top-0 left-[70%] w-[7%] h-full bg-blue-600 dark:bg-blue-700" style={{ clipPath: 'polygon(0 0, 100% 50%, 0 100%)', zIndex: 6 }}></div>
          <div className="absolute top-0 left-[82%] w-[9%] h-full bg-cyan-500 dark:bg-cyan-600" style={{ clipPath: 'polygon(30% 0, 100% 100%, 0 100%)', zIndex: 4 }}></div>
          <div className="absolute top-0 left-[92%] w-[7%] h-full bg-white dark:bg-gray-700" style={{ clipPath: 'polygon(0 0, 100% 0, 50% 100%)', zIndex: 5 }}></div>
        </div>
