...
import ProjectHierarchyPage from "@/pages/project-hierarchy-page";
...
import DevOpsWorkItemsPage from "@/pages/devops-workitems-page";
...
function Router() {
  return (
    <Switch>
      ...
      <ProtectedRoute path="/project-hierarchy" component={ProjectHierarchyPage} />
      ...
      <ProtectedRoute path="/devops-workitems" component={DevOpsWorkItemsPage} />
